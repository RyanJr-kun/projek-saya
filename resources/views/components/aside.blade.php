<aside class="sidenav bg-white navbar navbar-vertical navbar-expand-xs  my-0 fixed-start ms-- " id="sidenav-main">
    ...
    <div class="absolut sidenav-header my-2 ms-4">
      <a class="navbar-brand m-0" href="/dashboard">
        <img src="{{ asset('assets/img/logo.svg') }}" width="50px" height="50px" class="navbar-brand-img h-100" alt="main_logo">
        <span class="ms-1 fw-bold fs-18px">Computer</span>
      </a>
    </div>
      ...
      <ul class="navbar-nav">
        ...
        <li class="nav-item">
            <a class="nav-link {{ request()->is('role') ? 'active' : '' }}" href="/role">
                <div class="icon icon-shape icon-sm border-radius-md text-center me-2 d-flex align-items-center justify-content-center">
                <i class="bi bi-shield-shaded text-dark text-sm opacity-10"></i>
                </div>
