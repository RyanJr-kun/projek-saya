<x-layout>
    ...
    @section('breadcrumb')
        ...
        $breadcrumbItems = [
            ...
            ['name' => 'Manajemen Kategori', 'url' => route('kategoripengeluaran.index')],
        ];
        @endphp
    ...
    @push('scripts')
        ...
        <script>
            ...
            nama.addEventListener('change', function(){
                fetch('/dashboard/kategoripengeluaran/chekSlug?nama=' + nama.value)
            ...
            if (editModal) {
                ...
                editNama.addEventListener('change', function(){
                    fetch(`/dashboard/kategoripengeluaran/chekSlug?nama=${this.value}`)
                        .then(response => response.json())
                ...
                const deleteModal = document.getElementById('deleteConfirmationModal');
                    if (deleteModal) {
                        deleteModal.addEventListener('show.bs.modal', function (event) {
                            ...
                            deleteForm.action = `/kategoripengeluaran/${kategoriSlug}`; // <-- DIUBAH DI SINI
                        });
                    }
