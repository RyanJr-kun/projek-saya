                            ...
                            <table class="table table-hover align-items-center justify-content-start mb-0" id="tableData">
                                ...
                                <tbody id="isiTable">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <p title="kategori pengeluaran" class="text-xs text-dark fw-bold mb-0">{{ $pengeluaran->kategori_pengeluaran->nama }}</p>
                                        </td>
                                        <td>
                        ...
                        <form action="{{ route('pengeluaran.store') }}" method="post">
                            ...
                            <div class="row">
                                <div class="col-md-6 mb-3">
                                    <label for="kategori_pengeluaran_id" class="form-label">Kategori</label>
                                    <select name="kategori_pengeluaran_id" id="kategori_pengeluaran_id" class="form-select @error('kategori_pengeluaran_id') is-invalid @enderror" required>
                                        <option value="">Pilih Kategori</option>
                                        @foreach ($kategoris as $kategori)
                                            <option value="{{ $kategori->id }}" {{ old('kategori_pengeluaran_id') == $kategori->id ? 'selected' : '' }}>{{ $kategori->nama }}</option>
                                        @endforeach
                                    </select>
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form id="editPengeluaranForm" method="post">
                            ...
                            <div class="row">
                                <div class="col-md-6 mb-3">
                                    <label for="edit_kategori_pengeluaran_id" class="form-label">Kategori</label>
                                    <select name="kategori_pengeluaran_id" id="edit_kategori_pengeluaran_id" class="form-select" required>
                                        <option value="">Pilih Kategori</option>
                                        @foreach ($kategoris as $kategori)
                    ...
                    editModal.addEventListener('show.bs.modal', function (event) {
                        ...
                        fetch(dataUrl)
                            ...
                            .then(data => {
                                ...
                                document.getElementById('edit_kategori_pengeluaran_id').value = data.kategori_pengeluaran_id;
