    ...
    <div class="container-fluid d-flex flex-column min-vh-90 p-3 mb-auto ">
            ...
            <div class="modal-dialog modal-dialog-centered">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form action="{{ route('kategoripemasukan.store') }}" method="post" >
                            @csrf
                            <div class="mb-3">
        ...
        <div class="modal fade" id="editModal" tabindex="-1" aria-labelledby="editModalLabel" aria-hidden="true">
            <div class="modal-dialog modal-dialog-centered">
                <div class="modal-content">
                    <div class="modal-header border-0 mb-n3">
                        <h6 class="modal-title" id="editModalLabel">Edit Kategori pemasukan</h6>
                        <button type="button" class="btn btn-close bg-danger rounded-3 me-1" data-bs-dismiss="modal" aria-label="Close"></button>
                    </div>
                    <div class="modal-body">
        ...
        <script>
            ...
            if (editModal) {
                ...
                editNama.addEventListener('change', function(){
                    fetch(`/dashboard/kategoripemasukan/chekSlug?nama=${this.value}`)
                        .then(response => response.json())
                ...
                const deleteModal = document.getElementById('deleteConfirmationModal');
                    if (deleteModal) {
                        deleteModal.addEventListener('show.bs.modal', function (event) {
                            ...
                            deleteForm.action = `/kategoripemasukan/${kategoriSlug}`; // <-- DIUBAH DI SINI
                        });
                    }
