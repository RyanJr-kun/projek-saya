...
<div class="card m-4 p-3">
  ...
  <div class="card-header p-0 mx-3 mt-3 position-relative z-index-1">
    ...
    <a href="javascript:;" class="d-block">
      <img src="{{ $produk['img-produk'] }}" class="w-10 h-10 border-radius-lg">
    </a>
    <p></p>
  </div>
  ...
  <div class="card-body pt-2">
    ...
    <span class="text-gradient text-primary text-uppercase text-xs font-weight-bold my-2">{{ $produk['kategori'] }}</span>
    <a href="javascript:;" class="card-title h5 d-block text-darker">
      {{ $produk['nama-produk'] }}
    </a>
    <h3 class=" mb-4"> Rp.{{ $produk['harga'] }}</h3>
    <div class="author align-items-center">
      <img src="{{ $produk['img'] }}" alt="..." class="avatar shadow">
      <div class="name ps-3">
